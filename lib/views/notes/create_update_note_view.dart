...
import 'package:ghj/utilities/generics/get_arguments.dart';
import 'package:ghj/services/auth/crud/cloud/cloud_note.dart';
import 'package:ghj/services/auth/crud/cloud/firebase_cloud_storage.dart';
...
class _CreateUpdateNoteViewState extends State<CreateUpdateNoteView> {
  ...
  void _textConrollerListener() async {
    final note = _note;
    if (note == null) {
      return;
    }
  ...
  void _setupTextControllerListener() {
    _textController.removeListener(_textConrollerListener);
    _textController.addListener(_textConrollerListener);
  }
